...
const translation_table := preload("res://translation/translation_table.en.translation")
...
func _on_TextEdit_text_changed():
	...
	if check_tags(text):
		...
		$dialogue_panel/DialogueLabel.messages = ["[spd 1][color=red]ERROR incorrect tag"]
...
func _on_DialogueLabel_dialogue_custom_event(data):
	$event_dialogue.dialog_text = "event emitted!\n" + data
	$event_dialogue.visible = true
